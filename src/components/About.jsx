  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-8 pt-20 text-center"
      >
        {/* Profile Image */}
        <motion.div
          ...
          className="absolute -top-16 left-[44%] -translate-x-1/2 transform"
        >
          <img
            src="/profile.png"
            alt="Your Profile"
        ...
        {/* Name */}
        <h2 className="text-3xl font-bold mt-4 text-gray-700 dark:text-gray-300">Sakthivel Govinthan</h2>

        {/* Description */}
        <p className="mt-3 text-gray-700 dark:text-gray-300 leading-relaxed px-8">
